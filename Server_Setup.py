...
model_params = {
    ...
    "num_type_a_1": mesa.visualization.Slider(
        "Type A 1 strating population", 8, 0, 100, description="Randomly distributed"
    ),
    "num_type_a_2": mesa.visualization.Slider(
        "Type A 2 strating population", 60, 0, 100, description="Randomly distributed"
    ),
    ...
    "grid_width": mesa.visualization.Slider(
        "Grid width", 50, 0, 100, description=""
    ),
